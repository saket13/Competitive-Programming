// <--------------------------------------------------------------------------------COMBINATIONS------------------------------------------------------------------------------>
//COMBINATION LIBRARY
// 1. Calculation C(n, r) modulo any number (prime or composite) using pascal triangle
// 2. Calculation of C(n, r) modulo prime in O(1) complexity requires precomputation of O(n)
// 3. Calculation of C(n, r) modulo any number(prime or composite) in O(n logn)
...
// For this we will have to first find the factorial of numbers upto max stored  in an array
const int MAX = 1e5 + 5;
